...
HTMLTITLEBREAK = """<!-- Change this to whatever you want your title breaks to look like, such as headers, footers, logo's, etc. -->"""
HTMLPAGEBREAK = """<!-- Change this to whatever you want your page breaks to look like, such as headers, footers, logo's, etc. -->"""
HTMLTOC = """<!-- Change this to whatever you want your TOC to look like -->"""
