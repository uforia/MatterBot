...
HELP = {
    'DEFAULT': {
        ...
        'desc': 'Query the Triage API for various types of information. Searches somewhat follow the format as laid out by '
                'the [Tria.ge documentation](https://tria.ge/docs/cloud-api/search/#search-operators). Two fields can be '
                'specified: `query:...` and `filter:...`. `query:` can be any of the type `MD5`, `SHA1`, `SHA256`, '
