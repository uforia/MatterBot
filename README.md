...
| Hybrid-Analysis                         | Threat Intel          | Look up IPs, hostnames, domains, URLs, MD5, SHA1, SHA256, SSDEEP hashes and VxFamily names                                                                                                                    | Yes: 'vetted' API key recommended                                   | No: basic functionality, Yes: additional features/details                                                                         |     |
